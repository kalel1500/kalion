...
class KalionConfigManager
{
    protected static array $defaults = [
        ...
        'kalion.provider.web_middlewares.force_array_session_in_cloud.active'                 => true,
        'kalion.provider.web_middlewares.force_array_session_in_cloud.cloud_user_agent_value' => 'kube-probe',
