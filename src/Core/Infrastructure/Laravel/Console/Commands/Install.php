...
class Install extends Command
{
    ...
    protected $signature = 'kalion:install
                    ...
                    {--rollback : Rollback all changes made by the command to the original state}
    ...
    public function handle()
    {
        ...
        $this->info('Iniciando instalación: ' . ($data->developMode ? '<fg=yellow>[DEVELOP]</>' : ''));
        ...
        $this->info('Instalación finalizada');
    }
     ...
     */
    public function callRequireComposerPackages(string $composer, array $packages, bool $isRemove = false): bool
    {
