...
* (breaking) Se han movido y renombrado los Atributos, Interfaces, Traits y otras clases:
  ...
  * Interfaces:
    ...
    * `Domain/Contracts/Services/CurrentUserContract.php`                          &rarr; `Domain/Contracts/Services/Auth/CurrentUser.php`
    * `Domain/Contracts/Services/LoginContract.php`                                &rarr; `Domain/Contracts/Services/Auth/Login.php`
    * `Domain/Contracts/Services/PasswordResetContract.php`                        &rarr; `Domain/Contracts/Services/Auth/PasswordReset.php`
    * `Domain/Contracts/Services/RegisterContract.php`                             &rarr; `Domain/Contracts/Services/Auth/Register.php`
