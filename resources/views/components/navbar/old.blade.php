...
<nav class="fixed left-0 right-0 top-0 z-50 border-b border-gray-200 bg-white px-4 py-2.5 dark:border-gray-700 dark:bg-gray-800">
    <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="hidden items-center justify-start xs:flex">
            ...
            <a href="https://flowbite.com" class="mr-4 flex items-center justify-between lg:mr-20">
            ...
            <form action="#" method="GET" class="hidden md:block md:pl-2">
                ...
                <div class="relative md:w-64 lg:w-96">
                    ...
                    <input type="text" name="email" id="topbar-search" class="focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-1.5 pl-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" placeholder="Search"/>
                </div>
            </form>
        </div>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" class="mr-1 rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600 md:hidden" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation">
            ...
            <!-- Notifications -->
            <button type="button" data-dropdown-toggle="dropdown-notifications" class="mr-1 rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600">
            ...
            <div id="dropdown-notifications" class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded-sm bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700">
                    ...
                    <a href="#" class="flex border-b border-gray-200 px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                        ...
                        <div class="w-full pl-3">
                            <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                ...
                                and
                                <span class="font-semibold text-gray-900 dark:text-white">5 others</span>
                    ...
                    <a href="#" class="flex border-b border-gray-200 px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                        ...
                        <div class="w-full pl-3">
                            <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                ...
                                and
                                <span class="font-semibold text-gray-900 dark:text-white">141 others</span>
                    ...
                    <a href="#" class="flex border-b border-gray-200 px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                        ...
                        <div class="w-full pl-3">
                            <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                ...
                                <span class="text-blue-600 dark:text-blue-500 font-medium">@bonnie.green</span> what do you say?
                            </div>
                ...
                <a href="#" class="text-md block bg-gray-50 py-2 text-center font-medium text-gray-900 hover:bg-gray-100 dark:bg-gray-600 dark:text-white dark:hover:underline">
                    <div class="inline-flex items-center">
                        <svg aria-hidden="true" class="mr-2 h-4 w-4 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Theme toggle -->
            <button type="button" class="mr-1 rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600" id="theme-toggle" data-tooltip-target="tooltip-theme-toggle">
