    ...
    <body class="bg-neutral-secondary">
        ...
        <section >
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-heading">
                    <img class="w-8 h-8 mr-2" src="@viteAsset(config('kalion.layout.logo_path'))" alt="logo">
                ...
                <div class="w-full sm:max-w-md md:mt-0 xl:p-0 bg-neutral-primary-soft rounded-base shadow border border-default">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <div>
                            ...
                            <p class="mt-1 font-light text-body-subtle">{{ $cardText }}</p>
                        </div>
