<x-kal::sidebar>
    ...
    <x-kal::sidebar.item>
        ...
        Pages
        <x-slot:dropdown id="pages">
            <x-kal::sidebar.item subitem href="{{ route('home.example1') }}">Settings</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem href="{{ route('home.example2') }}">Kanban</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem href="{{ route('home.example3') }}">Calendar</x-kal::sidebar.item>
        </x-slot:dropdown>
    </x-kal::sidebar.item>
    ...
    <x-kal::sidebar.item>
        ...
        Sales
        <x-slot:dropdown id="sales">
            <x-kal::sidebar.item subitem href="{{ route('shared.compare') }}">Products</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem>Billing</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem>Invoice</x-kal::sidebar.item>
        </x-slot:dropdown>
    </x-kal::sidebar.item>

    <x-kal::sidebar.item href="#" counter="4">
        <x-slot:icon>
    ...
    <x-kal::sidebar.item>
        ...
        Authentication
        <x-slot:dropdown id="authentication">
            <x-kal::sidebar.item subitem>Sign In</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem>Sign Up</x-kal::sidebar.item>
            <x-kal::sidebar.item subitem>Forgot Password</x-kal::sidebar.item>
        </x-slot:dropdown>
    </x-kal::sidebar.item>

    <x-kal::sidebar.separator/>

    <x-kal::sidebar.item href="#">
        <x-slot:icon>
    ...
    <x-slot:footer>
        <x-kal::sidebar.footer>
            <x-kal::sidebar.footer.item href="#">
            ...
            <x-kal::sidebar.footer.item href="#" id="settings" tooltip="Settings page">
            ...
            <x-kal::sidebar.footer.item id="language">
                ...
                <x-slot:dropdown>
                    ...
                    <x-kal::sidebar.footer.subitem>
                        <svg aria-hidden="true" class="mr-2 h-3.5 w-3.5 rounded-full" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-de" viewBox="0 0 512 512"><path fill="#ffce00" d="M0 341.3h512V512H0z"/><path d="M0 0h512v170.7H0z"/><path fill="#d00" d="M0 170.7h512v170.6H0z"/></svg>
                        Deutsch
                    </x-kal::sidebar.footer.subitem>

                    <x-kal::sidebar.footer.subitem>
                        <svg aria-hidden="true" class="mr-2 h-3.5 w-3.5 rounded-full" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-it" viewBox="0 0 512 512"><g fill-rule="evenodd" stroke-width="1pt"><path fill="#fff" d="M0 0h512v512H0z"/><path fill="#009246" d="M0 0h170.7v512H0z"/><path fill="#ce2b37" d="M341.3 0H512v512H341.3z"/></g></svg>
                        Italiano
                    </x-kal::sidebar.footer.subitem>
