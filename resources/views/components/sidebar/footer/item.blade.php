...
@if(!$isDropdown)
    ...
    @if($hasTooltip)
        <x-kal::tooltip id="tooltip-{{ $id }}" :content="$tooltip"/>
    @endif
...
@else
    ...
    <!-- Dropdown -->
    <div class="z-50 my-4 hidden list-none divide-y divide-gray-100 rounded-sm bg-neutral-primary-medium text-base shadow-sm" id="dropdown-{{ $id }}">
